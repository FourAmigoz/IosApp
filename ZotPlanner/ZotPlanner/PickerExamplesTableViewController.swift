...
class PickerExamplesTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showNumberPicker" {
            ...
            let numberPicker = numberNav.topViewController as! TestingViewController
            numberPicker.currentSelectedValue = pickedNumber
            numberPicker.presentationType = TestingViewController.PresentationType.numbers(scrollingStyleOption.selectedSegmentIndex,
        ...
        if segue.identifier == "showNamePicker" {
            ...
            let osxPicker = osxNav.topViewController as! TestingViewController
            osxPicker.currentSelectedValue = pickedOSX
            osxPicker.presentationType = TestingViewController.PresentationType.names(scrollingStyleOption.selectedSegmentIndex,
                                                                                            selectionStyleOption.selectedSegmentIndex)
